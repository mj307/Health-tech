...
export default function ChatPage() {
  ...
  const initialMessages = {
    1: [{ sender: "Sunny Smiles", text: "Hello!", timestamp: "8:30 PM" }],
    2: [{ sender: "Alcan Dental", text: "Be there soon!", timestamp: "8:30 PM" }],
    3: [{ sender: "Medha Janga Dental Clinic", text: "Hello! Do you have any questions?", timestamp: "8:30 PM" }],
  };
  ...
  const receiveBotMessage = (chatId) => {
    const botResponses = ["Hi Maha, thank you so much for coming in today on such short notice. You can find parking right in front of the clinic, in the parking spaces reserved for staff."];
